...
And, it can be connected to real EEG devices that analyse the brain electrical activity in real time to display the instantaneous brain activities.
With a visualisation of a 3D brain for a more clear and easy to use interface for any user. 
Be it a patient, nurse, doctor....etc. 
